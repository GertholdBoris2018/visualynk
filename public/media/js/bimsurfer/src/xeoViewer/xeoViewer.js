define([
    ...
    function xeoViewer(cfg) {
        ...
        this._setObjectColor = function (object, color) {
            console.log("set Object color clicked");
            var material = object.material;
            material.diffuse = [color[0],color[1],color[2]];
            material.on("diffuse", function (diffuse) {
                console.log("Entity's material's diffuse color is: " + JSON.stringify(diffuse));
            });
