...
var Model = function(bimServerApi, poid, roid, schema) {
            ...
            othis.bimServerApi.getJsonStreamingSerializer(function(serializer) {
                bimServerApi.call("ServiceInterface", "download", {
                    ...
                    othis.bimServerApi.getJson(url, null, function(data) {
                        ...
                        othis.waiters = [];
                        bimServerApi.call("ServiceInterface", "cleanupLongAction", {
                            topicId: topicId
                        }, function() {
    ...
    this.startTransaction = function(callback) {
        bimServerApi.call("LowLevelInterface", "startTransaction", {
            poid: othis.poid
        }, function(tid) {
            othis.tid = tid;
            callback(tid);
    ...
    this.create = function(className, object, callback) {
        ...
        bimServerApi.call("LowLevelInterface", "createObject", {
            tid: tid,
            className: className
        }, function(oid) {
            wrapper._i = oid;
    ...
    this.commit = function(comment, callback) {
        var tid = othis.checkTransaction();
        bimServerApi.call("LowLevelInterface", "commitTransaction", {
            tid: tid,
            comment: comment
        }, function(roid) {
            if (callback != null) {
    ...
    this.abort = function(callback) {
        var tid = othis.checkTransaction();
        bimServerApi.call("LowLevelInterface", "abortTransaction", {
            tid: tid
        }, function(roid) {
            if (callback != null) {
                callback();
    ...
    this.getClass = function(typeName) {
        if (othis.bimServerApi.classes[typeName] == null) {
            ...
            wrapperClass.remove = function(removeCallback) {
                var tid = othis.checkTransaction();
                bimServerApi.call("LowLevelInterface", "removeObject", {
                    tid: tid,
                    oid: this.object._i
                }, function() {
    ...
    this.size = function(callback) {
        bimServerApi.call("ServiceInterface", "getRevision", {
            roid: roid
        }, function(revision) {
    ...
    this.count = function(type, includeAllSubTypes, callback) {
        ...
        bimServerApi.call("LowLevelInterface", "count", {
            roid: roid,
            className: type
        }, function(size) {
            callback(size);
    ...
    this.getByGuids = function(guids, callback) {
        ...
        return othis.getByX("getByGuid", "guid", othis.guidsFetching, othis.objectsByGuid, query, function(object) {
    ...
    this.get = function(oids, callback) {
        ...
        return othis.getByX("get", "OID", othis.oidsFetching, othis.objects, query, function(object) {
            return object._i
        }, oids, callback);
    };
    this.getByName = function(names, callback) {
        ...
        return othis.getByX("getByName", "name", othis.namesFetching, othis.objectsByName, query, function(object) {
