define(["./EventHandler"], function(EventHandler) {
    ...
    function StaticTreeRenderer(args) {
        ...
        // View and Hide the IFC elements
        ...
        this.setSelected = function(ids, mode) {
          ...
          // Log the IDs of the selected element both in tree view and 3D model
          //console.log(ids);
            ...
            ids.forEach(function(id) {
              ...
              // Code to control click event in the IFC elements on the top
                var s = null;
                if (mode == TOGGLE) {
        ...
        // To build the tree structure, use the following code.
        this.build = function() {
            var build = function(modelId, d, n) {
                ...
                label.onclick = function(evt) {
                  ...
                  // Get the name, id, GUID, parent  and gid numbers of the selected element
                  //console.log(n.name);
                  //console.log(n.id);
                  //console.log(n.guid);
