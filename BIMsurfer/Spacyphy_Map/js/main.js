	...
	function initEvents() {
		...
		pins.forEach(function(pin) {
			...
			pin.addEventListener('click', function(ev) {
				ev.preventDefault();
				// Get the name of the selected pin on the floor maps
				var textValue = contentItem.children[0].innerText;
				xdLocalStorage.setItem('noktaIsim', textValue, function (data) { });
				xdLocalStorage.setItem('buyukHarfler', 'SPACYPHY', function (data) { });
